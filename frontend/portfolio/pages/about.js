          ...
          <Row className="mt-5">
            ...
            <Col md="6">
              <div className="fadein">
                ...
                <p>
                  I have a Bachelors degree in Artificial Intelligence and
                  several years of experience working on a wide range of
                  technologies and projects from JavaScript development to
                  modern mobile and web applications in React and Django.
                </p>
                <p>
